...
themeToggle ? (themeToggle.addEventListener("click", switchTheme, !1), window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change", a => a.matches && detectOSColorTheme()), window.matchMedia("(prefers-color-scheme: light)").addEventListener("change", a => a.matches && detectOSColorTheme()), detectOSColorTheme()) : localStorage.removeItem("theme");
    ...
    Prism = function(b) {
        var e = /\blang(?:uage)?-([\w-]+)\b/i,
            ...
            a = {
                ...
                util: {
                    encode: function b(a) {
                        return a instanceof c ? new c(a.type, b(a.content), a.alias) : Array.isArray(a) ? a.map(b) : a.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/\u00a0/g, " ")
                    },
                    type: function(a) {
                    ...
                    clone: function g(c, b) {
                        ...
                        switch (b = b || {}, a.util.type(c)) {
                            case "Object":
                                ...
                                return d;
                            case "Array":
                                return e = a.util.objId(c), b[e] ? b[e] : (d = [], b[e] = d, c.forEach(function(a, c) {
                                    d[c] = g(a, b)
                                }), d);
                            default:
                                return c
                ...
                languages: {
                    ...
                    insertBefore: function(f, i, d, e) {
                        ...
                        for (b in h)
                            ...
                            } return j = e[f], e[f] = c, a.languages.DFS(a.languages, function(a, b) {
                            b === j && a != f && (this[a] = c)
                        }), c
                    },
                    DFS: function i(f, g, j, c) {
                        var e, d, b, h;
                        c = c || {}, e = a.util.objId;
                        for (d in f) f.hasOwnProperty(d) && (g.call(f, d, f[d], j || d), b = f[d], h = a.util.type(b), "Object" !== h || c[e(b)] ? "Array" !== h || c[e(b)] || (c[e(b)] = !0, i(b, g, d, c)) : (c[e(b)] = !0, i(b, g, null, c)))
                    }
                },
                plugins: {},
                ...
                highlightElement: function(d, l, f) {
                    var g = a.util.getLanguage(d),
                        k = a.languages[g],
                        h, c, j;
                    d.className = d.className.replace(e, "").replace(/\s+/g, " ") + " language-" + g, h = d.parentElement, h && "pre" === h.nodeName.toLowerCase() && (h.className = h.className.replace(e, "").replace(/\s+/g, " ") + " language-" + g), c = {
                        element: d,
                        language: g,
                        grammar: k,
                        code: d.textContent
                    ...
                    a.hooks.run("before-highlight", c), c.grammar ? l && b.Worker ? (j = new Worker(a.filename), j.onmessage = function(a) {
                        i(a.data)
                    }, j.postMessage(JSON.stringify({
                        language: c.language,
                        code: c.code,
                        immediateClose: !0
                    }))) : i(a.highlight(c.code, c.grammar, c.language)) : i(a.util.encode(c.code))
                },
                            ...
                            for (n in v)
                                if (v.hasOwnProperty(n) && v[n]) {
                                    ...
                                    for (p = 0; p < o.length; ++p) {
                                        ...
                                        e = o[p], z = e.inside, D = !!e.lookbehind, C = !!e.greedy, H = e.alias, C && !e.pattern.global && (G = e.pattern.toString().match(/[imsuy]*$/)[0], e.pattern = RegExp(e.pattern.source, G + "g"));
                                        for (A = e.pattern || e, b = J.next, d = I; b !== j.tail && !(m && d >= m.reach); d += b.value.length, b = b.next) {
                                            ...
                                            if (!(k instanceof c)) {
                                                ...
                                                t = i.index, s = i[0], w = k.slice(0, t), B = k.slice(t + s.length), x = d + k.length, m && x > m.reach && (m.reach = x), r = b.prev, w && (r = f(j, r, w), d += w.length), l(j, r, u), E = new c(n, z ? a.tokenize(s, z) : s, H, s), b = f(j, r, E), B && f(j, b, B), 1 < u && K(y, j, v, b.prev, d, {
                                                    cause: n + "," + p,
                                                    reach: x
                                                })
                                            }
        ...
        if (b.Prism = a, c.stringify = function i(c, f) {
                var g, b, d, e, h;
                if ("string" == typeof c) return c;
                if (Array.isArray(c)) return g = "", c.forEach(function(a) {
                    g += i(a, f)
                }), g;
                b = {
                    type: c.type,
                    ...
                    attributes: {},
                    language: f
                }, d = c.alias, d && (Array.isArray(d) ? Array.prototype.push.apply(b.classes, d) : b.classes.push(d)), a.hooks.run("wrap", b), e = "";
                for (h in b.attributes) e += " " + h + '="' + (b.attributes[h] || "").replace(/"/g, "&quot;") + '"';
                return "<" + b.tag + ' class="' + b.classes.join(" ") + '"' + e + ">" + b.content + "</" + b.tag + ">"
            }, !b.document) return b.addEventListener && (a.disableWorkerMessageHandler || b.addEventListener("message", function(e) {
        ...
        return d && (a.filename = d.src, d.hasAttribute("data-manual") && (a.manual = !0)), !a.manual && (i = document.readyState, "loading" === i || "interactive" === i && d && d.defer ? document.addEventListener("DOMContentLoaded", g) : window.requestAnimationFrame ? window.requestAnimationFrame(g) : window.setTimeout(g, 16)), a
    }(_self);
"undefined" != typeof module && module.exports && (module.exports = Prism), "undefined" != typeof global && (global.Prism = Prism), Prism.languages.markup = {
    ...
    a.languages.css = {
        ...
        function: /[-a-z0-9]+(?=\()/i,
        punctuation: /[(){};:,]/
    }, a.languages.css.atrule.inside.rest = a.languages.css, c = a.languages.markup, c && (c.tag.addInlined("style", "css"), a.languages.insertBefore("inside", "attr-value", {
        "style-attr": {
    ...
    for (f = ["comment", "function-name", "for-or-select", "assign-left", "string", "environment", "function", "keyword", "builtin", "boolean", "file-descriptor", "operator", "punctuation", "number"], g = c.variable[1].inside, d = 0; d < f.length; d++) g[f[d]] = a.languages.bash[f[d]];
    ...
    v = m(k), j = RegExp(m(q + " " + k + " " + D + " " + o)), H = m(k + " " + D + " " + o), G = m(q + " " + k + " " + o), h = i("<(?:[^<>;=+\\-*/%&|^]|<<self>>)*>", 2), r = i("\\((?:[^()]|<<self>>)*\\)", 2), d = "@?\\b[A-Za-z_]\\w*\\b", l = b("<<0>>(?:\\s*<<1>>)?", [d, h]), f = b("(?!<<0>>)<<1>>(?:\\s*\\.\\s*<<1>>)*", [H, l]), n = "\\[\\s*(?:,\\s*)*\\]", F = b("<<0>>(?:\\s*(?:\\?\\s*)?<<1>>)*(?:\\s*\\?)?", [f, n]), g = b("(?:<<0>>|<<1>>)(?:\\s*(?:\\?\\s*)?<<2>>)*(?:\\s*\\?)?", [b("\\(<<0>>+(?:,<<0>>+)+\\)", [b("[^,()<>[\\];=+\\-*/%&|^]|<<0>>|<<1>>|<<2>>", [h, r, n])]), f, n]), c = {
        ...
        "class-name": [{
            pattern: a("(\\busing\\s+static\\s+)<<0>>(?=\\s*;)", [f]),
            lookbehind: !0,
            inside: c
        }, {
            pattern: a("(\\busing\\s+<<0>>\\s*=\\s*)<<1>>(?=\\s*;)", [d, g]),
            lookbehind: !0,
            inside: c
        }, {
            pattern: a("(\\busing\\s+)<<0>>(?=\\s*=)", [d]),
            lookbehind: !0
        }, {
            pattern: a("(\\b<<0>>\\s+)<<1>>", [v, l]),
            lookbehind: !0,
            inside: c
        }, {
            pattern: a("(\\bcatch\\s*\\(\\s*)<<0>>", [f]),
            lookbehind: !0,
            inside: c
        }, {
            pattern: a("(\\bwhere\\s+)<<0>>", [d]),
            lookbehind: !0
        }, {
            pattern: a("(\\b(?:is(?:\\s+not)?|as)\\s+)<<0>>", [F]),
            lookbehind: !0,
            inside: c
        }, {
            pattern: a("\\b<<0>>(?=\\s+(?!<<1>>)<<2>>(?:\\s*[=,;:{)\\]]|\\s+(?:in|when)\\b))", [g, G, d]),
            inside: c
        }],
        keyword: j,
        ...
        namespace: {
            pattern: a("(\\b(?:namespace|using)\\s+)<<0>>(?:\\s*\\.\\s*<<0>>)*(?=\\s*[;{])", [d]),
            lookbehind: !0,
            inside: {
                punctuation: /\./
            }
        ...
        "type-expression": {
            pattern: a("(\\b(?:default|typeof|sizeof)\\s*\\(\\s*(?!\\s))(?:[^()\\s]|\\s(?!\\s)|<<0>>)*(?=\\s*\\))", [r]),
            lookbehind: !0,
            alias: "class-name",
            inside: c
        },
        "return-type": {
            pattern: a("<<0>>(?=\\s+(?:<<1>>\\s*(?:=>|[({]|\\.\\s*this\\s*\\[)|this\\s*\\[))", [g, f]),
            inside: c,
            alias: "class-name"
        },
        "constructor-invocation": {
            pattern: a("(\\bnew\\s+)<<0>>(?=\\s*[[({])", [g]),
            lookbehind: !0,
            inside: c,
            alias: "class-name"
        },
    ...
    }), y = x + "|" + w, z = b("/(?![*/])|//[^\r\n]*[\r\n]|/\\*(?:[^*]|\\*(?!/))*\\*/|<<0>>", [y]), A = i(b("[^\"'/()]|<<0>>|\\(<<self>>*\\)", [z]), 2), B = "\\b(?:assembly|event|field|method|module|param|property|return|type)\\b", E = b("<<0>>(?:\\s*\\(<<1>>*\\))?", [f, A]), e.languages.insertBefore("csharp", "class-name", {
        attribute: {
    ...
    }), p = ":[^}\r\n]+", C = i(b("[^\"'/()]|<<0>>|\\(<<self>>*\\)", [z]), 2), t = b("\\{(?!\\{)(?:(?![}:])<<0>>)*<<1>>?\\}", [C, p]), s = i(b("[^\"'/()]|/(?!\\*)|/\\*(?:[^*]|\\*(?!/))*\\*/|<<0>>|\\(<<self>>*\\)", [y]), 2), u = b("\\{(?!\\{)(?:(?![}:])<<0>>)*<<1>>?\\}", [s, p]);
...
}(Prism), Prism.languages.dotnet = Prism.languages.cs = Prism.languages.csharp, ! function(a) {
    ...
    }, a.languages.css.atrule.inside["selector-function-argument"].inside = b, a.languages.insertBefore("css", "property", {
        variable: {
        ...
        tokenizePlaceholders: {
            value: function(c, d) {
                if (c.language === d && c.tokenStack) {
                    ...
                    ! function m(i) {
                        for (var j = 0, g, o, r, l, n, k, p, s, q, h; j < i.length && !(e >= f.length); j++) g = i[j], "string" == typeof g || g.content && "string" == typeof g.content ? (o = f[e], r = c.tokenStack[o], l = "string" == typeof g ? g : g.content, n = b(d, o), k = l.indexOf(n), -1 < k && (++e, p = l.substring(0, k), s = new a.Token(d, a.tokenize(r, c.grammar), "language-" + d, r), q = l.substring(k + n.length), h = [], p && h.push.apply(h, m([p])), h.push(s), q && h.push.apply(h, m([q])), "string" == typeof g ? i.splice.apply(i, [j, 1].concat(h)) : g.content = h)) : g.content && m(g.content);
                        return i
                    }(c.tokens)
                }
            }
    ...
    }), a.languages.jinja2 = a.languages.django, a.hooks.add("before-tokenize", function(a) {
    ...
    var b, c;
    "groovy" === a.language && "string" === a.type && (b = a.content[0], "'" != b && (c = /([^\\])(?:\$(?:\{.*?\}|[\w.]+))/, "$" === b && (c = /([^\$])(?:\$(?:\{.*?\}|[\w.]+))/), a.content = a.content.replace(/&lt;/g, "<").replace(/&amp;/g, "&"), a.content = Prism.highlight(a.content, {
        expression: {
            pattern: c,
            lookbehind: !0,
    ...
    delete a.languages.ruby.function, a.languages.insertBefore("ruby", "keyword", {
        regex: [{
    ...
    for (d = ["css", {
        ...
        }, "erb", "javascript", "less", "markdown", "ruby", "scss", "textile"], e = {}, c = 0, f = d.length; c < f; c++) b = d[c], b = "string" == typeof b ? {
        filter: b,
        language: b
    } : b, a.languages[b.language] && (e["filter-" + b.filter] = {
    ...
    for (b in d) d[b] && (c = c || {}, i = h[b] ? (void 0, g = (f = b).replace(/^[a-z]+\//, ""), "(?:" + f + "|\\w+/(?:[\\w.-]+\\+)+" + g + "(?![+\\w.-]))") : b, c[b.replace(/\//g, "-")] = {
        pattern: RegExp("(content-type:\\s*" + i + ".*)(?:\\r?\\n|\\r){2}[\\s\\S]*", "i"),
        lookbehind: !0,
        inside: d[b]
    });
    ...
    a.languages.php = {
        ...
        /<\?/.test(b.code) && a.languages["markup-templating"].buildPlaceholders(b, "php", /<\?(?:[^"'/#]|\/(?![*/])|("|')(?:\\[\s\S]|(?!\1)[^\\])*\1|(?:\/\/|#(?!\[))(?:[^?\n\r]|\?(?!>))*(?=$|\?>|[\r\n])|#\[|\/\*(?:[^*]|\*(?!\/))*(?:\*\/|$))*?(?:\?>|$)/gi)
    }), a.hooks.add("after-tokenize", function(b) {
    ...
    Object.defineProperty(b, "addSupport", {
        value: function(b, c) {
            "string" == typeof b && (b = [b]), b.forEach(function(b) {
                ! function(g, f) {
                    var e = "doc-comment",
                        d = a.languages[g],
                        b, h, c, i;
                    if (d)
                        if (b = d[e], b || (h = {
                            ...
                            }, b = (d = a.languages.insertBefore(g, "comment", h))[e]), b instanceof RegExp && (b = d[e] = {
                                pattern: b
                            }), Array.isArray(b))
                            for (c = 0, i = b.length; c < i; c++) b[c] instanceof RegExp && (b[c] = {
                                pattern: b[c]
                            }), f(b[c]);
                        else f(b)
                }(b, function(a) {
    ...
    delete b["class-name"], a.languages.typescript["class-name"].inside = b, a.languages.insertBefore("typescript", "function", {
        "generic-function": {
    ...
    a.languages.insertBefore("javascript", "function-variable", {
        ...
        exports: {
            pattern: d("(\\bexport\\b\\s*)(?:\\*(?:\\s*as\\s+<ID>)?(?=\\s*\\bfrom\\b)|\\{[^{}]*\\})"),
            lookbehind: !0,
            inside: a.languages.javascript
        }
    ...
    for (e = ["function", "function-variable", "method", "method-variable", "property-access"], c = 0; c < e.length; c++) f = e[c], b = a.languages.javascript[f], "RegExp" === a.util.type(b) && (b = a.languages.javascript[f] = {
        pattern: b
    }), g = b.inside || {}, (b.inside = g)["maybe-class-name"] = /^[A-Z][\s\S]*/
...
}, Prism.languages.webmanifest = Prism.languages.json, ! function(a) {
    var b = /("|')(?:\\(?:\r\n?|\n|.)|(?!\1)[^\\\r\n])*\1/;
    a.languages.json5 = a.languages.extend("json", {
        property: [{
            pattern: RegExp(b.source + "(?=\\s*:)"),
            greedy: !0
        }, {
    ...
    }), delete a.languages.kotlin["class-name"], a.languages.insertBefore("kotlin", "string", {
        "raw-string": {
            pattern: /("""|''')[\s\S]*?\1/,
            alias: "string"
        }
    ...
    var a = "[-+*/_~!@$%^=<>{}\\w]+",
        ...
        b = {
            ...
            keyword: [{
                pattern: RegExp(c + "(?:(?:lexical-)?let\\*?|(?:cl-)?letf|if|when|while|unless|cons|cl-loop|and|or|not|cond|setq|error|message|null|require|provide|use-package)" + i),
                lookbehind: !0
            }, {
                pattern: RegExp(c + "(?:for|do|collect|return|finally|append|concat|in|by)" + i),
                lookbehind: !0
            }],
            declare: {
                pattern: j("declare"),
            ...
            lambda: {
                pattern: RegExp(c + "lambda\\s+\\(\\s*(?:&?" + a + "(?:\\s+&?" + a + ")*\\s*)?\\)"),
                lookbehind: !0,
                inside: {
                    keyword: /^lambda/,
                    arguments: null,
    ...
    a.languages.phpdoc = a.languages.extend("javadoclike", {
        parameter: {
            pattern: RegExp("(@(?:global|param|property(?:-read|-write)?|var)\\s+(?:" + b + "\\s+)?)\\$\\w+"),
            lookbehind: !0
        }
    ...
    var d = a.util.clone(a.languages.javascript),
        b, c;
    a.languages.jsx = a.languages.extend("markup", d), a.languages.jsx.tag.pattern = /<\/?(?:[\w.:-]+(?:\s+(?:[\w.:$-]+(?:=(?:"(?:\\[^]|[^\\"])*"|'(?:\\[^]|[^\\'])*'|[^\s{'">=]+|\{(?:\{(?:\{[^{}]*\}|[^{}])*\}|[^{}])+\}))?|\{\s*\.{3}\s*[a-z_$][\w$]*(?:\.[a-z_$][\w$]*)*\s*\}))*\s*\/?)?>/i, a.languages.jsx.tag.inside.tag.pattern = /^<\/?[^\s>\/]*/i, a.languages.jsx.tag.inside["attr-value"].pattern = /=(?!\{)(?:"(?:\\[^]|[^\\"])*"|'(?:\\[^]|[^\\'])*'|[^\s'">]+)/i, a.languages.jsx.tag.inside.tag.inside["class-name"] = /^[A-Z]\w*(?:\.[A-Z]\w*)*$/, a.languages.insertBefore("inside", "attr-name", {
        spread: {
    ...
    }, a.languages.jsx.tag), a.languages.insertBefore("inside", "attr-value", {
        script: {
            pattern: /=(?:\{(?:\{(?:\{[^{}]*\}|[^{}])*\}|[^{}])+\})/i,
            inside: {
                "script-punctuation": {
    ...
    }, a.languages.jsx.tag), b = function(a) {
        return a ? "string" == typeof a ? a : "string" == typeof a.content ? a.content : a.content.map(b).join("") : ""
    }, c = function(g) {
        for (var e = [], f = 0, d, i, h; f < g.length; f++) d = g[f], i = !1, ("string" != typeof d && ("tag" === d.type && d.content[0] && "tag" === d.content[0].type ? "</" === d.content[0].content[0].content ? 0 < e.length && e[e.length - 1].tagName === b(d.content[0].content[1]) && e.pop() : "/>" === d.content[d.content.length - 1].content || e.push({
            tagName: b(d.content[0].content[1]),
            openedBraces: 0
        }) : 0 < e.length && "punctuation" === d.type && "{" === d.content ? e[e.length - 1].openedBraces++ : 0 < e.length && 0 < e[e.length - 1].openedBraces && "punctuation" === d.type && "}" === d.content ? e[e.length - 1].openedBraces-- : i = !0), (i || "string" == typeof d) && 0 < e.length && 0 === e[e.length - 1].openedBraces) && (h = b(d), f < g.length - 1 && ("string" == typeof g[f + 1] || "plain-text" === g[f + 1].type) && (h += b(g[f + 1]), g.splice(f + 1, 1)), 0 < f && ("string" == typeof g[f - 1] || "plain-text" === g[f - 1].type) && (h = b(g[f - 1]) + h, g.splice(f - 1, 1), f--), g[f] = new a.Token("plain-text", h, null, h)), d.content && "string" != typeof d.content && c(d.content)
    }, a.hooks.add("after-tokenize", function(a) {
    ...
    for (var a = "/\\*(?:[^*/]|\\*(?!/)|/(?!\\*)|<self>)*\\*/", c = 0; c < 2; c++) a = a.replace(/<self>/g, function() {
        return a
    });
    a = a.replace(/<self>/g, function() {
        ...
        punctuation: /->|\.\.=|\.{1,3}|::|[{}[\];(),:]/,
        operator: /[-+*\/%!^]=?|=[=>]?|&[&=]?|\|[|=]?|<<?=?|>>?=?|[@?]/
    }, b.languages.rust["closure-params"].inside.rest = b.languages.rust, b.languages.rust.attribute.inside.string = b.languages.rust.string
}(Prism), ! function(a) {
...
}), Prism.languages.scss.atrule.inside.rest = Prism.languages.scss, ! function(a) {
    var b = ["([\"'])(?:\\\\[^]|\\$\\([^)]+\\)|\\$(?!\\()|`[^`]+`|(?!\\1)[^\\\\`$])*\\1", "<<-?\\s*([\"']?)(\\w+)\\2\\s[^]*?[\r\n]\\3"].join("|");
...
}), Prism.languages.swift.string.inside.interpolation.inside.rest = Prism.languages.swift, ! function(b) {
    function a(a) {
    ...
    b.languages.toml = {
        ...
        table: {
            pattern: RegExp(a("(^\\s*\\[\\s*(?:\\[\\s*)?)__(?:\\s*\\.\\s*__)*(?=\\s*\\])"), "m"),
            lookbehind: !0,
            greedy: !0,
            alias: "class-name"
        },
        key: {
            pattern: RegExp(a("(^\\s*|[{,]\\s*)__(?:\\s*\\.\\s*__)*(?=\\s*=)"), "m"),
            lookbehind: !0,
            greedy: !0,
            alias: "property"
        },
    ...
    function b(b, c) {
        a.languages[b] && a.languages.insertBefore(b, "comment", {
            "doc-comment": c
        })
    }
    ...
    if ("undefined" != typeof self && self.Prism && self.document && document.querySelector) {
        var c, i = function() {
                if (void 0 === c) {
                    ...
                    a.style.fontSize = "13px", a.style.lineHeight = "1.5", a.style.padding = "0", a.style.border = "0", a.innerHTML = "&nbsp;<br />&nbsp;", document.body.appendChild(a), c = 38 === a.offsetHeight, document.body.removeChild(a)
                }
                return c
            },
            e = !0,
        ...
        Prism.hooks.add("before-sanity-check", function(c) {
            var b = c.element.parentElement,
                ...
                d;
            b && e && /pre/i.test(b.nodeName) && (d = 0, a(".line-highlight", b).forEach(function(a) {
            ...
            var a = c.element.parentElement,
                ...
                i, j;
            a && e && /pre/i.test(a.nodeName) && (clearTimeout(f), i = Prism.plugins.lineNumbers, j = c.plugins && c.plugins.lineNumbers, b(a, "line-numbers") && i && !j ? Prism.hooks.add("line-numbers", g) : (d(a, e)(), f = setTimeout(h, 1)))
        }), window.addEventListener("hashchange", h), window.addEventListener("resize", function() {
            a("pre[data-line]").map(function(a) {
                return d(a)
            }).forEach(g)
        })
    }
    ...
    function d(c, l, t) {
        ...
        if (s.forEach(function(f) {
                ...
                }), j && Prism.plugins.lineNumbers ? (g = Prism.plugins.lineNumbers.getLine(c, b), h = Prism.plugins.lineNumbers.getLine(c, e), g && (k = g.offsetTop + n + "px", d.push(function() {
                    a.style.top = k
                })), h && (l = h.offsetTop - g.offsetTop + h.offsetHeight + "px", d.push(function() {
                    a.style.height = l
                }))) : d.push(function() {
            ...
            o && (b(c, k) || d.push(function() {
                c.className = (c.className + " " + k).trim()
            }), u = parseInt(c.getAttribute("data-start") || "1"), a(".line-numbers-rows > span", c).forEach(function(a, b) {
                var c = b + u;
                a.onclick = function() {
                    var a = m + "." + c;
                    e = !1, location.hash = a, setTimeout(function() {
                        e = !0
                    }, 1)
                }
            }))
    ...
    function h() {
        ...
        }), f = (b.match(/\.([\d,-]+)$/) || [, ""])[1], f && !document.getElementById(b) && (g = b.slice(0, b.lastIndexOf(".")), c = document.getElementById(g), c && (c.hasAttribute("data-line") || c.setAttribute("data-line", ""), d(c, f, "temporary ")(), e && document.querySelector(".temporary.line-highlight").scrollIntoView()))
    }
}(), ! function() {
    if ("undefined" != typeof self && self.Prism && self.document) {
            ...
            e = Prism.plugins.lineNumbers = {
                getLine: function(d, b) {
                    ...
                    if ("PRE" === d.tagName && d.classList.contains(a))
                        if (e = d.querySelector(".line-numbers-rows"), e) return c = parseInt(d.getAttribute("data-start"), 10) || 1, f = c + (e.children.length - 1), b < c && (b = c), f < b && (b = f), g = b - c, e.children[g]
                },
                resize: function(a) {
                    b([a])
                },
        ...
        window.addEventListener("resize", function() {
            ...
            var f, d, g, h, i, j;
            e.code && (f = e.element, d = f.parentNode, d && /pre/i.test(d.nodeName) && !f.querySelector(".line-numbers-rows") && Prism.util.isActive(f, a) && (f.classList.remove(a), d.classList.add(a), h = e.code.match(c), i = h ? h.length + 1 : 1, j = new Array(i + 1).join("<span></span>"), (g = document.createElement("span")).setAttribute("aria-hidden", "true"), g.className = "line-numbers-rows", g.innerHTML = j, d.hasAttribute("data-start") && (d.style.counterReset = "linenumber " + (parseInt(d.getAttribute("data-start"), 10) - 1)), e.element.appendChild(g), b([d]), Prism.hooks.run("line-numbers", e)))
        ...
        if (0 != (a = a.filter(function(b) {
            ...
            var b = a.map(function(b) {
                var d = b.querySelector("code"),
                    ...
                    a, f, g;
                if (d && e) return a = b.querySelector(".line-numbers-sizer"), f = d.textContent.split(c), a || ((a = document.createElement("span")).className = "line-numbers-sizer", d.appendChild(a)), a.innerHTML = "0", a.style.display = "block", g = a.getBoundingClientRect().height, a.innerHTML = "", {
                    element: b,
                    lines: f,
                    lineHeights: [],
                    oneLinerHeight: g,
            ...
            b.forEach(function(a) {
                var d = a.sizer,
                    ...
                    c = a.lineHeights,
                    e = a.oneLinerHeight;
                c[b.length - 1] = void 0, b.forEach(function(a, f) {
                    if (a && 1 < a.length) {
                ...
                b.style.display = "none", b.innerHTML = "", a.lineHeights.forEach(function(a, b) {
    ...
    var b, a, c, d, e;
    "undefined" != typeof self && self.Prism && self.document && (b = [], a = {}, c = function() {}, Prism.plugins.toolbar = {}, d = Prism.plugins.toolbar.registerButton = function(d, c) {
        var e;
        e = "function" == typeof c ? c : function(b) {
            var a;
            return "function" == typeof c.onClick ? ((a = document.createElement("button")).type = "button", a.addEventListener("click", function() {
                c.onClick.call(this, b)
            })) : "string" == typeof c.url ? (a = document.createElement("a")).href = c.url : a = document.createElement("span"), c.className && a.classList.add(c.className), a.textContent = c.text, a
        ...
        var d = f.element.parentNode,
            e, g, h, i;
        d && /pre/i.test(d.nodeName) && !d.parentNode.classList.contains("code-toolbar") && (e = document.createElement("div"), e.classList.add("code-toolbar"), d.parentNode.insertBefore(e, d), e.appendChild(d), g = document.createElement("div"), g.classList.add("toolbar"), h = b, i = function(a) {
            for (; a;) {
                var b = a.getAttribute("data-toolbar-order");
                if (null != b) return (b = b.trim()).length ? b.split(/\s*,\s*/g) : [];
                a = a.parentElement
            }
        }(f.element), i && (h = i.map(function(b) {
            return a[b] || c
        ...
        if (Prism.plugins.toolbar) {
            ...
            Prism.plugins.toolbar.registerButton("show-language", function(c) {
                ...
                if (d && /pre/i.test(d.nodeName))
                    if (e = d.getAttribute("data-language") || a[c.language] || ((b = c.language) && (b.substring(0, 1).toUpperCase() + b.substring(1)).replace(/s(?=cript)/, "S")), e) return f = document.createElement("span"), f.textContent = e, f
            })
